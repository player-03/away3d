...
class UVAnimator extends AnimatorBase implements IAnimator
{
	...
	{
		var material:TextureMaterial = renderable.material is TextureMaterial ? cast renderable.material : null;
		var subMesh:SubMesh = renderable is SubMesh ? cast renderable : null;
