...
class LightsHelper
{
	...
	private static function apply(materialOwner:IMaterialOwner):Void
	{
		...
		if (materialOwner.material != null) {
			switch (_state) {
				case 0:
					picker = materialOwner.material.lightPicker is StaticLightPicker ? cast materialOwner.material.lightPicker : null;
				...
				case 1:
					...
					picker = null;
					if (materialOwner.material.lightPicker is StaticLightPicker)
